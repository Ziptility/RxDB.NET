...
public class EfDocumentService<TDocument, TContext>(
    TContext context,
    IEventPublisher eventPublisher,
    ILogger<EfDocumentService<TDocument, TContext>> logger) : BaseDocumentService<TDocument>(eventPublisher, logger)
